...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/morning-cake-47c6
```

A live public deployment of this template is available at [https://morning-cake-47c6.templates.workers.dev](https://morning-cake-47c6.templates.workers.dev)
